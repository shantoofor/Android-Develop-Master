...
public class CircleProgressBar extends ProgressBar {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mProgressTextFormatPattern = a.hasValue(R.styleable.CircleProgressBar_circle_progress_text_format_pattern) ?
                a.getString(R.styleable.CircleProgressBar_circle_progress_text_format_pattern) : DEFAULT_PATTERN;
        ...
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_circle_progress_text_size, UnitUtils.dip2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
        mProgressStrokeWidth = a.getDimensionPixelSize(R.styleable.CircleProgressBar_circle_progress_stroke_width, UnitUtils.dip2px(getContext(), DEFAULT_PROGRESS_STROKE_WIDTH));

        mProgressStartColor = a.getColor(R.styleable.CircleProgressBar_circle_progress_start_color, Color.parseColor(COLOR_FFF2A670));
        mProgressEndColor = a.getColor(R.styleable.CircleProgressBar_circle_progress_end_color, Color.parseColor(COLOR_FFF2A670));
        mProgressTextColor = a.getColor(R.styleable.CircleProgressBar_circle_progress_text_color, Color.parseColor(COLOR_FFF2A670));
        mProgressBackgroundColor = a.getColor(R.styleable.CircleProgressBar_circle_progress_background_color, Color.parseColor(COLOR_FFD3D3D5));
